...
VL_ATTR_COLD void Vaccel_tb_top_accel_tb_pkg___ctor_var_reset(Vaccel_tb_top_accel_tb_pkg* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaccel_tb_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaccel_tb_top_accel_tb_pkg___ctor_var_reset\n"); );
}
