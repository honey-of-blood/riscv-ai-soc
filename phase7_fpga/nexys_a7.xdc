## Nexys A7-50T / A7-100T XDC Constraints
## Device: XC7A50T-1CSG324C (50T) or XC7A100T-1CSG324C (100T)
## ----------------------------------------------------------------------------
...
## Reset — BTNC push-button (active-low, CPU_RESETN)
...
## UART (optional — not used by soc_top v1, wired for future firmware printf)
## RXD: D10 (from host), TXD: A9 (to host)
