...
riscv_core u_cpu (
    ...
    .icache_stall_i(1'b0),          // I-cache not wired into SoC yet (Phase 15)
...
logic is_mmio;
// 0x1000_xxxx peripherals, 0x5000_xxxx accel ctrl, 0x5001_xxxx scratchpad
assign is_mmio = (dmem_addr[31:16] == 16'h1000) |
                 (dmem_addr[31:17] == 15'h2800);   // covers 0x5000_xxxx & 0x5001_xxxx
